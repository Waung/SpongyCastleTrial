package com.example.spongycastletrial;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
//            Security.addProvider(new org.bouncycastle.jce.provider.SpongyCastleProvider());
            testSpongyCastle();
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    void testSpongyCastle() throws Exception
    {
